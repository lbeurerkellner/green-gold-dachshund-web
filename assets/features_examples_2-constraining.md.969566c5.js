import{_ as n,o as e,c as t,Q as o,k as s,a}from"./chunks/framework.c2adf1ba.js";const j=JSON.parse('{"title":"⛓️ Constrained LLMs","description":"","frontmatter":{"title":"⛓️ Constrained LLMs"},"headers":[],"relativePath":"features/examples/2-constraining.md","filePath":"features/examples/2-constraining.md"}'),p={name:"features/examples/2-constraining.md"},l=o(`<p>LMQL&#39;s support for constrained generation enables robust interfacing, to integrate LLMs safely into your applications.<a href="../../guide/constraints.html">Learn More →</a></p><p>%SPLIT%</p><div class="language-lmql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">lmql</span><pre class="hljs"><code><span class="line"><span class="hljs-comment"># top-level strings are prompts</span>
...
A: [PUNCHLINE| Dam!]
`,animate:"true",__animate:"true","animate-speed":"50",class:"promptdown promptdown-compiled",style:{opacity:"1"}},[s("p",{"pd-shadow-id":"1934",text:"T","pd-insertion-point":"true"},[a(`Tell me a joke:

Q: `),s("span",{"pd-shadow-id":"1936","pd-instant":"false",text:"",class:"promptdown-var color-lightorange"},[s("span",{"pd-shadow-id":"1937",text:"J",class:"promptdown-var-name"},"JOKE"),a(" What did the fish say when it hit the wall?")]),a(`
A: `),s("span",{"pd-shadow-id":"1942","pd-instant":"false",text:"",class:"promptdown-var color-orange"},[s("span",{"pd-shadow-id":"1943",text:"P",class:"promptdown-var-name"},"PUNCHLINE"),a(" Dam")]),a(`
`)])])],-1),i=[l,r];function c(d,h,m,_,u,g){return e(),t("div",null,i)}const f=n(p,[["render",c]]);export{j as __pageData,f as default};
