    ...
    `),e("span",{class:"hljs-string"},'"events"'),s(`: [
        {
            ...
            `),e("span",{class:"hljs-string"},'"data"'),s(`: {
                ...
                `),e("span",{class:"hljs-string"},'"tokenier"'),s(": "),e("span",{class:"hljs-string"},`"<LMQLTokenizer 'gpt-3.5-turbo-instruct' using tiktoken <Encoding 'cl100k_base'>>"`),s(`,
...
</span></code></pre></div><p>This produces one certificate for all calls made in the defined context, where each query is represented as a separate item in the list of <code>children</code> certificates. Recorded events are are nested in child certificates. Additionally, an aggregated <code>metrics</code> object ranging over all (recursive) calls is included in the top-level certificate.</p><h2 id="certificate-callbacks" tabindex="-1">Certificate Callbacks <a class="header-anchor" href="#certificate-callbacks" aria-label="Permalink to &quot;Certificate Callbacks&quot;">​</a></h2><p>As an alternative to directly writing certificates to a file, the <code>certificate</code> argument can also be used to specify a callback function that is called with the generated certificate as an argument. This can be used to integrate certificate generation into custom workflows.</p><p>The callback is provided with a single <code>certificate</code> object, which is of type <code>lmql.InferenceCertificate</code>. The certificate can be directly serialized to JSON using string conversion, i.e., <code>str(certificate)</code>.</p>`,11),p=[l,r,o];function h(d,u,f,m,g,j){return a(),i("div",null,p)}const v=n(c,[["render",h]]);export{_ as __pageData,v as default};
