import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.980cae92.js";const m=JSON.parse('{"title":"Internal Reasoning","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"docs/lib/chat/internal.md","filePath":"docs/lib/chat/internal.md"}'),t={name:"docs/lib/chat/internal.md"},o=e(`<h1 id="internal-reasoning" tabindex="-1">Internal Reasoning <a class="header-anchor" href="#internal-reasoning" aria-label="Permalink to &quot;Internal Reasoning&quot;">​</a></h1><p>While user-facing question-answering is the main goal of LLM-based chatbots, performance can be considerably improved by implementing internal reasoning and reflection mechanisms. In this chapter, we will discuss the implementation of such mechanisms in LMQL Chat.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="hljs"><code><span class="line">:name: lmql-chat
:alt: A chatbot <span class="hljs-keyword">with</span> internal reasoning capabilities.
:align: center

A chatbot <span class="hljs-keyword">with</span> internal reasoning capabilities.
</span></code></pre></div><p>Building on the simple chat application implemented in <a href="./overview.html"></a>, we extend the chat loop as follows:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="hljs"><code><span class="line"><span class="hljs-keyword">from</span> lmql.lib.chat <span class="hljs-keyword">import</span> message
